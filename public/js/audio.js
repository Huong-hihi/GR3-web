    ...
    if (supportsAudio) {
        ...
        let controls = `<div class="plyr__controls">
                            <button class="plyr__controls__item plyr__control" type="button" data-plyr="restart">
                                ...
                                <span class="plyr__sr-only">Restart</span></button>

                            <div class="plyr__controls__item plyr__progress__container">
                                <div class="plyr__progress"><input data-plyr="seek" type="range" min="0" max="100"
                            ...
                            <div class="plyr__controls__item plyr__volume">
                                ...
                                <input data-plyr="volume" type="range" min="0" max="1" step="0.05" value="1"
                                       ...
                                       aria-valuetext="45.0%" style="--value:45%;"></div>
                        ...
                        <div class="group-controls-playlist">
                                ...
                                <a class="plyr__controls__item plyr__control song-download"
                                ...
                                <button class="plyr__controls__item plyr__control">
                                    <i classname="bx bx-plus-circle recommend-add-image"></i>
                                </button>
                            </div>`;
        var player = new Plyr('#audio1', {
            controls
            ...
            // $('.plyr__controls').append(`<i className='bx bx-plus-circle recommend-add-image'></i>`)
